    ...
    public static void main(String[] args){
        ...
        try{
            ...
            String query1 = "CREATE TABLE IF NOT EXISTS dishes (id_dish INT(10) NOT NULL AUTO_INCREMENT,"
                    + "name VARCHAR(255),ingredients VARCHAR(255),price DOUBLE(10),"
                    + "food_preference ENUM('FULL_MENU','VEGETARIAN','VEGAN'),time_created datetime DEFAULT CURRENT_TIMESTAMP,"
                    + "PRIMARY KEY(id_dish));";
