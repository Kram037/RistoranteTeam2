...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        DishMenu<Drinks> drinksList = new DishMenu<>();
        drinksList.addDish(new Drinks("Acqua Ferragni", "Water", 7.50, FoodPreferences.VEGAN));
        drinksList.addDish(new Drinks("Barbera", "Red Wine", 15, FoodPreferences.VEGETARIAN));
        drinksList.addDish(new Drinks("CocaCola", "Water, sugar, food preservative, secret recipe", 15, FoodPreferences.VEGETARIAN));
